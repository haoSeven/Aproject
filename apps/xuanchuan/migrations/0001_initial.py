    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ty', '停用'), ('qy', '启用')], default='qy', max_length=5, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accept_user', models.ManyToManyField(related_name='items_accept_user', to=settings.AUTH_USER_MODEL, verbose_name='接受人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=30, verbose_name='标题')),
                ('status', models.CharField(choices=[('wait', '待审批'), ('success', '已审批')], default='wait', max_length=10, verbose_name='状态')),
                ('style', models.CharField(default='宣传信息申请', max_length=20, verbose_name='宣传信息申请')),
                ...
                ('remark', models.CharField(max_length=200, verbose_name='备注')),
                ('file', models.FileField(blank=True, default='', null=True, upload_to='xc/files/%Y/%m', verbose_name='附件')),
                ('accept_user', models.ManyToManyField(related_name='message_accept_user', to=settings.AUTH_USER_MODEL, verbose_name='接受人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='xuanchuan.Items', verbose_name='宣传资料领用表')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='items',
            name='opinion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='xuanchuan.Opinion', verbose_name='领导意见'),
        ),
        migrations.AddField(
            model_name='itemmake',
            name='lis',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='xuanchuan.Items', verbose_name='宣传资料制作表'),
        ),
    ]
